...
class RBTree:
    ...
    def insert(self, val):
        ...
        new_node.red = True  # Новый узел должен быть красный
        ...
        # Устанавливаем родителя и вставляем новый узел
